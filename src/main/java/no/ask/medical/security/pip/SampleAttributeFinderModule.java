...
package no.ask.medical.security.pip;
...
public class SampleAttributeFinderModule extends AttributeFinderModule{
    ...
    private static final String ROLE_ID = "http://medical/id/role";

	private static final String DEPARTMENT_PATIENT = "http://medical/id/department-patient";
